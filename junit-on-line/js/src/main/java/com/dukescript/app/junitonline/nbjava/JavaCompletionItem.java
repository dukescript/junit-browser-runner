...
package com.dukescript.app.junitonline.nbjava;

import com.dukescript.app.junitonline.javac.CompletionItem;
import java.util.*;
...
//    private static final Logger LOGGER = Logger.getLogger(JavaCompletionItem.class.getName());
    ...
    public static JavaCompletionItem createTypeItem(CompilationInfo info, TypeElement elem, DeclaredType type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean insideNew, boolean addTypeVars, boolean addSimpleName, boolean smartType, boolean autoImportEnclosingType/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        switch (elem.getKind()) {
            case CLASS:
                return new ClassItem(info, elem, type, 0, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, addTypeVars, addSimpleName, smartType, autoImportEnclosingType/*TODO:, whiteList*/);
            case INTERFACE:
                return new InterfaceItem(info, elem, type, 0, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, addTypeVars, addSimpleName, smartType, autoImportEnclosingType/*TODO:, whiteList*/);
            case ENUM:
                return new EnumItem(info, elem, type, 0, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, addSimpleName, smartType, autoImportEnclosingType/*TODO:, whiteList*/);
            case ANNOTATION_TYPE:
                return new AnnotationTypeItem(info, elem, type, 0, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, addSimpleName, smartType, autoImportEnclosingType/*TODO:, whiteList*/);
            default:
                throw new IllegalArgumentException("kind=" + elem.getKind());
        }
    }

    public static JavaCompletionItem createArrayItem(CompilationInfo info, ArrayType type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ Elements elements/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        int dim = 0;
        TypeMirror tm = type;
        ...
        if (tm.getKind() == TypeKind.DECLARED || tm.getKind() == TypeKind.ERROR) {
            ...
            switch (elem.getKind()) {
                case CLASS:
                    return new ClassItem(info, elem, dt, dim, substitutionOffset, /*TODO:referencesCount,*/ elements.isDeprecated(elem), false, false, false, true, false/*TODO:, whiteList*/);
                case INTERFACE:
                    return new InterfaceItem(info, elem, dt, dim, substitutionOffset, /*TODO:referencesCount,*/ elements.isDeprecated(elem), false, false, false, true, false/*TODO:, whiteList*/);
                case ENUM:
                    return new EnumItem(info, elem, dt, dim, substitutionOffset, /*TODO:referencesCount,*/ elements.isDeprecated(elem), false, false, true, false/*TODO:, whiteList*/);
                case ANNOTATION_TYPE:
                    return new AnnotationTypeItem(info, elem, dt, dim, substitutionOffset, /*TODO:referencesCount,*/ elements.isDeprecated(elem), false, false, true, false/*TODO:, whiteList*/);
            }
        }
    ...
    public static JavaCompletionItem createVariableItem(CompilationInfo info, VariableElement elem, TypeMirror type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isInherited, boolean isDeprecated, boolean smartType, int assignToVarOffset/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        switch (elem.getKind()) {
            case LOCAL_VARIABLE:
            ...
            case ENUM_CONSTANT:
            case FIELD:
                return new FieldItem(info, elem, type, substitutionOffset, /*TODO:referencesCount,*/ isInherited, isDeprecated, smartType, assignToVarOffset/*TODO:, whiteList*/);
            default:
                throw new IllegalArgumentException("kind=" + elem.getKind());
        }
    }
    ...
    public static JavaCompletionItem createExecutableItem(CompilationInfo info, ExecutableElement elem, ExecutableType type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isInherited, boolean isDeprecated, boolean inImport, boolean addSemicolon, boolean smartType, int assignToVarOffset, boolean memberRef/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        switch (elem.getKind()) {
            case METHOD:
                return new MethodItem(info, elem, type, substitutionOffset, /*TODO:referencesCount,*/ isInherited, isDeprecated, inImport, addSemicolon, smartType, assignToVarOffset, memberRef/*TODO:, whiteList*/);
            case CONSTRUCTOR:
                return new ConstructorItem(info, elem, type, substitutionOffset, isDeprecated, smartType, null/*TODO:, whiteList*/);
            default:
                throw new IllegalArgumentException("kind=" + elem.getKind());
        }
    }

    public static JavaCompletionItem createThisOrSuperConstructorItem(CompilationInfo info, ExecutableElement elem, ExecutableType type, int substitutionOffset, boolean isDeprecated, String name/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        if (elem.getKind() == ElementKind.CONSTRUCTOR) {
            return new ConstructorItem(info, elem, type, substitutionOffset, isDeprecated, false, name/*TODO:, whiteList*/);
        }
        throw new IllegalArgumentException("kind=" + elem.getKind());
    }
...
//    }
    ...
    public static JavaCompletionItem createAnnotationItem(CompilationInfo info, TypeElement elem, DeclaredType type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
        return new AnnotationItem(info, elem, type, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, true/*TODO:, whiteList*/);
    }
...
//    public static JavaCompletionItem createAttributeValueItem(CompilationInfo info, String value, String documentation, TypeElement element, int substitutionOffset/*TODO:, ReferencesCount referencesCount, WhiteListQuery.WhiteList whiteList*/) {
//        return new AttributeValueItem(info, value, documentation, element, substitutionOffset/*TODO:, referencesCount, whiteList*/);
//    }
//
...
//    }
    ...
    public static final String OWN = " Own"; //NOI18N
...
//
    ...
    public final CompletionItem toCompletionItem() {
        return new CompletionItem(getInsertPrefix(), getLeftHtmlText(), getStyle());
    }
    
    protected abstract int getSortPriority();

    protected abstract CharSequence getSortText();

    protected abstract String getInsertPrefix();
...
//        private boolean autoImportEnclosingType;
        ...
        private ClassItem(CompilationInfo info, TypeElement elem, DeclaredType type, int dim, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean insideNew, boolean addTypeVars, boolean addSimpleName, boolean smartType, boolean autoImportEnclosingType/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(substitutionOffset);
...
//        }
    ...
    private static class InterfaceItem extends ClassItem {
        ...
        private InterfaceItem(CompilationInfo info, TypeElement elem, DeclaredType type, int dim, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean insideNew, boolean addTypeVars, boolean addSimpleName, boolean smartType, boolean autoImport/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(info, elem, type, dim, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, addTypeVars, addSimpleName, smartType, autoImport/*TODO:, whiteList*/);
        }
    ...
    private static class EnumItem extends ClassItem {
        ...
        private EnumItem(CompilationInfo info, TypeElement elem, DeclaredType type, int dim, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean insideNew, boolean addSimpleName, boolean smartType, boolean autoImport/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(info, elem, type, dim, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, false, addSimpleName, smartType, autoImport/*TODO:, whiteList*/);
        }
    ...
    private static class AnnotationTypeItem extends ClassItem {
        ...
        private AnnotationTypeItem(CompilationInfo info, TypeElement elem, DeclaredType type, int dim, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean insideNew, boolean addSimpleName, boolean smartType, boolean autoImport/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(info, elem, type, dim, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, insideNew, false, addSimpleName, smartType, autoImport/*TODO:, whiteList*/);
        }
...
//        private CharSequence assignToVarText;
        ...
        private FieldItem(CompilationInfo info, VariableElement elem, TypeMirror type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isInherited, boolean isDeprecated, boolean smartType, int assignToVarOffset/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(substitutionOffset);
...
//
        ...
        protected String getStyle() {
            ...
            if (isStatic) {
                switch (level) {
                    case PRIVATE_LEVEL:
                        style = STYLE_ST_PRIVATE;
                        break;
                    case PACKAGE_LEVEL:
                        style = STYLE_ST_PACKAGE;
                        break;
                    case PROTECTED_LEVEL:
                        style = STYLE_ST_PROTECTED;
                        break;
                    case PUBLIC_LEVEL:
                        style = STYLE_ST;
                        break;
...
//    }
    ...
    private static class ConstructorItem extends JavaCompletionItem {
        ...
        private static final String STYLE_PACKAGE = "Java-hint ConstructorPackagePrivate"; //NOI18N
        private static final String STYLE_PRIVATE = "Java-hint ConstructorPrivate"; //NOI18N
        private static final String STYLE_PROTECTED = "Java-hint ConstructorProtected"; //NOI18N
//        private static final String PARAMETER_NAME_COLOR = getHTMLColor(224, 160, 65);
...
//        private boolean isAbstract;
        ...
        private ConstructorItem(CompilationInfo info, ExecutableElement elem, ExecutableType type, int substitutionOffset, boolean isDeprecated, boolean smartType, String name /*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(substitutionOffset);
            this.isDeprecated = isDeprecated;
            this.smartType = smartType;
...
//
//        private static final String STYLE = "Java-hint NewConstructor"; //NOI18N
//
//        private boolean smartType;
//        private String simpleName;
//        private boolean isAbstract;
...
//    }
//
//    private static class ParametersItem extends JavaCompletionItem {
//
//        private static final String ACTIVE_PARAMETER_COLOR = getHTMLColor(64, 64, 64);
...
//    }
    ...
    private static class AnnotationItem extends AnnotationTypeItem {
        ...
        private AnnotationItem(CompilationInfo info, TypeElement elem, DeclaredType type, int substitutionOffset, /*TODO:ReferencesCount referencesCount,*/ boolean isDeprecated, boolean smartType/*TODO:, WhiteListQuery.WhiteList whiteList*/) {
            super(info, elem, type, 0, substitutionOffset, /*TODO:referencesCount,*/ isDeprecated, false, false, smartType, false/*TODO:, whiteList*/);
        }
...
//        private static final String VALUE_COLOR = getHTMLColor(192, 192, 192);
...
//    private static class AttributeValueItem extends JavaCompletionItem {
//
...
//        private String leftText;
//
//        private AttributeValueItem(CompilationInfo info, String value, String documentation, TypeElement element, int substitutionOffset/*TODO:, ReferencesCount referencesCount, WhiteListQuery.WhiteList whiteList*/) {
//            super(substitutionOffset);
...
//            if (element != null) {
//                delegate = createTypeItem(info, element, (DeclaredType)element.asType(), substitutionOffset, /*TODO:referencesCount,*/ false, false, false, false, false, false/*TODO:, getWhiteList()*/);
//            }
//        }
//
//        @Override
